      ...
      >
        <div className="bg-card border border-border/50 rounded-2xl shadow-2xl overflow-hidden">
          <div className="gradient-accent px-8 py-6">
            <h1 className="font-display text-2xl text-accent-foreground">Create your account</h1>
            <p className="text-sm text-accent-foreground/70 font-sans mt-1">Start designing smarter, for free</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="px-8 py-6 space-y-5">
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-sans font-medium text-muted-foreground uppercase tracking-wide">Full Name</label>
              <input
                type="text"
                value={name}
