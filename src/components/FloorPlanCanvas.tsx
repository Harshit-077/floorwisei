...
export default function FloorPlanCanvas({
  ...
  const getFurnitureColor = (type: string) => {
    const colors: Record<string, string> = {
      ...
      'tv-unit': 'hsl(210 25% 30%)', bookshelf: 'hsl(30 35% 40%)', 'bed-double': 'hsl(26 40% 50%)',
      'bed-single': 'hsl(26 35% 55%)', wardrobe: 'hsl(210 30% 38%)', nightstand: 'hsl(30 35% 42%)',
      dresser: 'hsl(210 25% 42%)', 'dining-table': 'hsl(30 45% 42%)', chair: 'hsl(30 40% 48%)',
      'kitchen-counter': 'hsl(26 40% 45%)', stove: 'hsl(0 40% 40%)', fridge: 'hsl(210 30% 65%)',
      sink: 'hsl(210 35% 55%)', bathtub: 'hsl(210 40% 60%)', toilet: 'hsl(0 0% 75%)',
      basin: 'hsl(210 30% 55%)', desk: 'hsl(30 35% 40%)', 'office-chair': 'hsl(210 30% 45%)',
      'car-porch': 'hsl(0 0% 60%)', staircase: 'hsl(30 25% 50%)',
    };
  ...
  return (
    <svg ref={svgRef} viewBox="0 0 1000 700" className="w-full h-full canvas-grid bg-card"
